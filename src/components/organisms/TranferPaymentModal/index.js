...
export default function VaBankTransferModal({ open, onClickClose }) {
  return (
    <div>
      <Modal
        open={open}
...
VaBankTransferModal.propTypes = {
  open: PropTypes.bool,
  onClickClose: PropTypes.func,
};

VaBankTransferModal.defaultProps = {
  open: false,
  onClickClose: () => {},
};
